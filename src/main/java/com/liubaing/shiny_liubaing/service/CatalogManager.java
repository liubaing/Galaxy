...
import com.liubaing.shiny_liubaing.repository.jpa.CatalogRepository;
import com.liubaing.shiny_liubaing.repository.jpa.UserRepository;
import com.liubaing.shiny_liubaing.service.apns.PushWithAsp;
...
public class CatalogManager
{
	...
	public void reset(int aspID){
		...
		//推送新课程消息
		apnsManager.pushNotifications(new PushWithAsp(), aspID);
	}
