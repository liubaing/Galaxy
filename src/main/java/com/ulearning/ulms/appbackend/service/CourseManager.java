...
import com.ulearning.ulms.appbackend.service.apns.PushWithUser;
import com.ulearning.ulms.appbackend.util.core.Const;
import com.ulearning.ulms.appbackend.util.core.DateTimeUtils;
...
public class CourseManager
{
	...
	public void reset(int userID){
		...
		this.resetCourses(userID);
		//推送新课程消息
		Apns apns = new Apns(userID, new PushWithUser());
